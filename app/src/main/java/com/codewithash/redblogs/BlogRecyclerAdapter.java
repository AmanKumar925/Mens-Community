...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        String title_data = blog_list.get(position).getDesc();
...
//                if (currentUserId.equals(view.getResources().getString(R.string.demoid)))
//                {
//                    Toast.makeText(context, "Login With Official Account", Toast.LENGTH_SHORT).show();
//                }
//                else {
...
//        });
        holder.blogLikeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentUserId.equals(v.getResources().getString(R.string.demoid)))
                {
                    Toast.makeText(context, "Login With Official Account", Toast.LENGTH_SHORT).show();
                }
                else {
...
//        });
    ...
    public  class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setUserData(String name, String image){
            ...
            placeholderOption.placeholder(R.drawable.empty_fav);
